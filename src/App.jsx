...
import { CalendarDays, LineChart, History, LogOut } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/fluxo', label: 'Fluxo', icon: LineChart, soon: true },
  { to: '/historico', label: 'Histórico', icon: History, soon: true },
]
